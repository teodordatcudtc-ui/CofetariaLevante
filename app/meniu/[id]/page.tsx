        ...
        <div className="container-custom">
          ...
          >
            ...
            <div>
              ...
              <p className="text-xl text-accent mb-6">{product.description}</p>
              <p className="text-accent mb-8 leading-relaxed">{product.fullDescription}</p>

              <div className="space-y-4 mb-8">
                <div>
                  <h3 className="font-serif text-lg text-primary mb-2">Ingrediente</h3>
                  <p className="text-accent">{product.ingredients}</p>
                </div>
                {product.allergens && (
                  <div>
                    <h3 className="font-serif text-lg text-primary mb-2">Alergeni</h3>
                    <p className="text-accent">{product.allergens}</p>
                  </div>
                )}
                <div>
